...
export default function FacultyLoginPage() {
  ...
  const [email, setEmail] = useState('priya.mehta@university.edu');
  ...
  return (
    <AuthLayout title="Faculty Sign In" subtitle="Access your exam management dashboard">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4" data-testid="form-faculty-login">
